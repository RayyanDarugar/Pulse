...
const CreatorCard: React.FC<CreatorCardProps> = ({ creator }) => {
    return (
        <div className="group relative flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10 hover:-translate-y-1">
            ...
            <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-6 flex items-center justify-between border-t border-gray-100 pt-4">
                    ...
                    <button className="rounded-full bg-indigo-50 px-4 py-2 text-sm font-semibold text-indigo-600 hover:bg-indigo-100">
                        View
                    </button>
                </div>
            </div>
