...
const HowItWorks: React.FC = () => {
    return (
        <div className="bg-neutral-bg min-h-screen font-sans text-neutral-strong overflow-hidden relative selection:bg-indigo-500 selection:text-white">
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-stretch">
                        ...
                        <motion.div
                            ...
                            className="p-10 rounded-3xl bg-neutral-card/10 border border-white/5 flex flex-col justify-center relative group"
                        >
                            <div className="absolute inset-0 bg-red-500/5 group-hover:bg-red-500/10 transition-colors rounded-3xl" />
                            <h3 className="text-3xl font-bold text-neutral-muted mb-6 relative z-10 flex items-center gap-3">
                                <BarChart3 className="text-red-500/50" />
                                Attention Economy
                            </h3>
                            <ul className="space-y-4 text-neutral-muted relative z-10 text-lg">
                        ...
                        <motion.div
                            ...
                            className="p-10 rounded-3xl bg-neutral-card border border-indigo-500/30 shadow-[0_0_50px_-12px_rgba(99,102,241,0.25)] flex flex-col justify-center relative overflow-hidden group"
                        >
            ...
            <section className="py-32 px-4 relative">
                <div className="container mx-auto max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-neutral-muted text-lg">Three steps to turn cultural influence into shared wealth.</p>
                    </motion.div>
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center max-w-3xl relative z-10">
                    ...
                    <h2 className="text-4xl font-bold mb-8 text-neutral-strong">Built on Trust, Not Hype.</h2>
...
const Card = ({ number, title, desc, icon, delay }: { number: string, title: string, desc: string, icon: React.ReactNode, delay: number }) => (
    <motion.div
        ...
        className="relative bg-neutral-card/10 border border-white/10 backdrop-blur-xl p-8 rounded-2xl hover:bg-white/10 transition-colors group"
    >
